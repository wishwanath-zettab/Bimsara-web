...
const guideSteps = [
  {
    ...
    content: [
      ...
      { bold: '2. Times have changed.', text: 'Purchasers now use AI and also get professionals such as architects, civil structural engineers, valuers etc. in their decision-making process and are routinely represented by brokers.' },
      ...
      { bold: '9. Have a plan.', text: 'Real estate marketing involves far more than an ad in the Property website, paper or social media. More than publishing advertisements. Successful Real Estate Professionals use a variety of methods to attract and qualify prospects, including both traditional and the latest communication methodologies.' },
