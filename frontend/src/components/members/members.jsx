  ...
  return (
    <div className="Members_component">
      <div className="members-stage">
        ...
        {/* key forces remount on selection change, triggering the fade-in animation */}
        <div className="inner-circle" key={selected.id}>
            ...
            <div className="inner-circle-main">
              ...
              {selected.link && (
                <a href={selected.link} target="_blank" rel="noopener noreferrer" style={{ cursor: "pointer", zIndex: 1 }}>
                  <img alt="LinkedIn" src={linked} className="linked" />
                </a>
              )}
            </div>
